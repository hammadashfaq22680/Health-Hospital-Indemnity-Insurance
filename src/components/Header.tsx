    ...
    <header className="sticky top-0 z-40 bg-white border-b border-slate-200 shadow-xs">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-18 flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-3 text-left focus:outline-hidden focus-visible:ring-2 focus-visible:ring-blue-600 rounded-lg p-1"
        ...
        <div className="hidden sm:flex items-center gap-3">
          <a
            href={phoneTel}
            className="inline-flex items-center justify-center gap-2.5 px-4 py-2.5 rounded-lg bg-blue-700 hover:bg-blue-800 active:bg-blue-900 text-white font-semibold text-sm shadow-xs transition-all duration-150 focus:outline-hidden focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-600"
        ...
        <div className="flex items-center gap-2 sm:hidden">
          <a
            href={phoneTel}
            className="p-2 rounded-lg bg-blue-700 text-white flex items-center justify-center"
            aria-label="Call Now"
          >
          ...
          <button
            ...
            className="p-2 rounded-lg text-slate-700 hover:bg-slate-100 focus:outline-hidden focus-visible:ring-2 focus-visible:ring-blue-600"
        ...
        <div className="lg:hidden fixed inset-x-0 top-[96px] bottom-0 bg-white/95 backdrop-blur-md z-50 border-b border-slate-200 overflow-y-auto px-5 py-6">
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-slate-900 rounded-xl p-4 text-white">
              ...
              <a
                href={phoneTel}
                className="w-full inline-flex items-center justify-center gap-2 py-3 px-4 rounded-lg bg-teal-600 hover:bg-teal-500 text-white font-bold text-base shadow-sm"
              >
            ...
            <div className="pt-4 border-t border-slate-200">
              <button
                ...
                className="w-full py-2.5 text-center text-sm font-medium text-blue-700 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors"
              >
